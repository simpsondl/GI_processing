...
On the associated Github repository, there is a Data folder which contains separate files for the meta information as well as the counts for each construct in the 2023 screen. These files are compressed to fit on Github and will need to be uncompressed with the utility of your choice before proceeding. To follow the commands in this document exactly, please make a new directory and place this Rmarkdown document in it. Inside the new directory, make another directory titled Screen2023, and place all files located in the Data folder on the associated github repository inside. Uncompress the meta information and counts files. Then opening this Rmarkdown document from inside the new folder will then allow the relative filepaths in this document to hold and run without modification. 

```{r rf}
library(readr)
library(dplyr)

# This file contains all counts 
counts <- read_tsv("Screen2023/screen2023_raw_counts_all_arms.txt", show_col_types = FALSE)
head(counts)

# This file contains meta information
meta <- read_tsv("Screen2023/construct_meta_info.txt", show_col_types = FALSE)
head(meta)

# Join the counts and meta information together using the shared ConstructID column
counts <- left_join(counts, meta)

# It's helpful to create a "map" of gene pairs with their identifiers
idmap <- read_tsv("Screen2023/pseudogenecombination_id_map.txt")
```
...
Functions for performing these two filters are below. Note that these functions expect your data to have the same structure as in these example files. Most notably, there must be meta information columns in the counts file that contain columns named FirstPosition, SecondPosition, and ConstructID. Adjust functions or data structure as preferred.
...
write_tsv(raw_phenotypes, "Screen2023/screen2023_raw_phenotypes.txt")
write_tsv(orind.phenotypes, "Screen2023/screen2023_orientation_averaged_phenotypes.txt")
write_tsv(single.pheno, "Screen2023/screen2023_single_sgRNA_phenotypes.txt")
write_tsv(to.filt, "Screen2023/screen2023_guide_combination_filter_flags.txt")
```
...
# Save flags to file
write_tsv(to.filt, "Screen2023/screen2023_all_flags_orind.txt")
```
...
Before computing GI scores, prepare directories to hold the resulting information. Functions and filepaths can be modified as desired to reduce outputs.

```{r dirstructure, eval = FALSE}
if(!dir.exists("Screen2023/Interaction_Scores/")){
  dir.create("Screen2023/Interaction_Scores/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Compiled/")){
  dir.create("Screen2023/Interaction_Scores/Compiled/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Compiled/Construct_Scores/")){
  dir.create("Screen2023/Interaction_Scores/Compiled/Construct_Scores/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Compiled/GuideCombination_Scores/")){
  dir.create("Screen2023/Interaction_Scores/Compiled/GuideCombination_Scores/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Compiled/GeneCombination_Scores/")){
  dir.create("Screen2023/Interaction_Scores/Compiled/GeneCombination_Scores/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Compiled/Model_Results/")){
  dir.create("Screen2023/Interaction_Scores/Compiled/Model_Results/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Gamma.OI.R1/")){
  dir.create("Screen2023/Interaction_Scores/Gamma.OI.R1/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Gamma.OI.R2/")){
  dir.create("Screen2023/Interaction_Scores/Gamma.OI.R2/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Gamma.OI.Avg/")){
  dir.create("Screen2023/Interaction_Scores/Gamma.OI.Avg/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Tau.OI.R1/")){
  dir.create("Screen2023/Interaction_Scores/Tau.OI.R1/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Tau.OI.R2/")){
  dir.create("Screen2023/Interaction_Scores/Tau.OI.R2/")
}

if(!dir.exists("Screen2023/Interaction_Scores/Tau.OI.Avg/")){
  dir.create("Screen2023/Interaction_Scores/Tau.OI.Avg/")
}
...
for(i in single.pheno.filt.gamma$sgRNA.ID){
  ...
  write_tsv(gamma.oi.avg.gi[[1]], paste("Screen2023/Interaction_Scores/Gamma.OI.Avg/", i, ".txt", sep = ""))
  if(i %in% single.pheno.filt.tau$sgRNA.ID){
    ...
    write_tsv(tau.oi.avg.gi[[1]], paste("Screen2023/Interaction_Scores/Tau.OI.Avg/", i, ".txt", sep = ""))
  }
}
```
...
con_path_pfx <- "Screen2023/Interaction_Scores/Compiled/Construct_Scores/"
...
mod_path_pfx <- "Screen2023/Interaction_Scores/Compiled/Model_Results/"
...
sgc_path_pfx <- "Screen2023/Interaction_Scores/Compiled/GuideCombination_Scores/"
...
gc_path_pfx <- "Screen2023/Interaction_Scores/Compiled/GeneCombination_Scores/"
